...
class Pxltheme_Core
{
    ...
    {
        wp_enqueue_style('pxl-admin-css', PXL_URL . 'assets/css/admin.css', [], self::VERSION);
        wp_style_add_data('pxl-admin-css', 'rtl', 'replace');
        wp_enqueue_script('pxl-admin-js', PXL_URL . 'assets/js/pxl-admin.js', ['jquery'], self::VERSION, true);
