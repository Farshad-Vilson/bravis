 ...
 * Swipper Lib
*/
if(!function_exists('saliver_elements_scripts')){
    add_action( 'wp_enqueue_scripts', 'saliver_elements_scripts');
    function saliver_elements_scripts() {  
        ...
        wp_register_script('saliver-particle', get_template_directory_uri() . '/elements/assets/js/particle.js', [ 'jquery' ], $theme->get( 'Version' ), true);
        wp_register_script('saliver-parallax', get_template_directory_uri() . '/elements/assets/js/parallax.js', [ 'jquery' ], $theme->get( 'Version' ), true);
        ...
        wp_register_script('saliver-counter', get_template_directory_uri() . '/elements/assets/js/counter.js', [ 'jquery' ], $theme->get( 'Version' ), true);
        wp_register_script('saliver-accordion', get_template_directory_uri() . '/elements/assets/js/accordion.js', [ 'jquery' ], $theme->get( 'Version' ), true);
        wp_register_script('saliver-tabs', get_template_directory_uri() . '/elements/assets/js/tabs.js', [ 'jquery' ], $theme->get( 'Version' ), true);
        wp_register_script('saliver-progressbar', get_template_directory_uri() . '/elements/assets/js/progressbar.js', [ 'jquery' ], $theme->get( 'Version' ), true);
        wp_register_script('saliver-countdown', get_template_directory_uri() . '/elements/assets/js/countdown.js', [ 'jquery' ], $theme->get( 'Version' ), true);
        ...
        wp_enqueue_script('saliver-elementor', get_template_directory_uri() . '/elements/assets/js/elementor.js', [ 'jquery' ], $theme->get( 'Version' ), true);
        ...
        wp_register_script( 'pxl-matter', get_template_directory_uri() . '/assets/js/libs/matter.min.js', array( 'jquery' ), '0.20.0', true );  
...
if(!function_exists('saliver_register_custom_icon_library')){
    add_filter('elementor/icons_manager/native', 'saliver_register_custom_icon_library');
    function saliver_register_custom_icon_library($tabs){
        $custom_tabs = [
            'pxl_icon1' => [
                'name' => 'flaticon',
                'label' => esc_html__( 'Saliver', 'saliver' ),
                'url' => false,
                'enqueue' => false,
                'prefix' => 'flaticon-',
...
*/
if(!function_exists('saliver_get_class_widget_path')){
    function saliver_get_class_widget_path(){
...
*/
function saliver_get_post_type_options($pt_supports=[]){
...
*/
function saliver_get_post_grid_layout($pt_supports = []){
    $post_types  = saliver_get_post_type_options($pt_supports); 
    $result = [];
    if (!is_array($post_types))
        return $result;
    foreach ($post_types as $name => $label) {
        $result[] = array(
            'name'     => 'layout_'.$name,
            'label'    => sprintf(esc_html__( 'Select Template of %s', 'saliver' ), $label),
            'type'     => 'layoutcontrol',
            'default' => 'post-1',
            'options'  => saliver_get_grid_layout_options($name),
...
function saliver_get_grid_layout_options($post_type_name){
    $option_layouts = [];
    switch ($post_type_name) {
        ...
        case 'post':  
            $option_layouts = [
                ...
                'post-2' => [
                    'label' => esc_html__( 'Layout 2', 'saliver' ),
                    'image' => get_template_directory_uri() . '/elements/assets/img/pxl_post_grid/post-layout2.jpg'
                ],
            ];
            break;
        ...
        //         'product-2' => [
        //             'label' => esc_html__( 'Layout 2', 'saliver' ),
        //             'image' => get_template_directory_uri() . '/elements/assets/img/pxl_post_grid/product-layout2.jpg'
        //         ],
        //     ];
        //     break;
    }
...
function saliver_get_grid_term_by_post_type($pt_supports = [], $args=[]){
    ...
    foreach ($post_types as $name => $label) {
        ...
        $result[] = array(
            'name'     => 'source_'.$name,
            'label'    => sprintf(esc_html__( 'Select Term of %s', 'saliver' ), $label),
...
function saliver_get_grid_ids_by_post_type($pt_supports = [], $args = []){
    $args = wp_parse_args($args, ['condition' => 'post_type', 'custom_condition' => []]);
    $post_types = saliver_get_post_type_options($pt_supports);
    $result = [];
    if (!is_array($post_types))
    ...
    foreach ($post_types as $name => $label) {
        ...
        $posts = saliver_list_post($name, false);
 
        $result[] = array(
            'name' => 'source_' . $name . '_post_ids',
            'label' => sprintf(esc_html__('Select posts', 'saliver'), $label),
            'type'     => \Elementor\Controls_Manager::SELECT2,
            'multiple' => true,
            'options' => $posts,
            'condition' => array_merge(
...
*/
function saliver_get_post_carousel_layout($pt_supports = []){
    $post_types  = saliver_get_post_type_options($pt_supports); 
    $result = [];
    if (!is_array($post_types))
        return $result;
    foreach ($post_types as $name => $label) {
        $result[] = array(
            ...
            'type'     => 'layoutcontrol',
            'default' => 'post-1',
            'options'  => saliver_get_carousel_layout_options($name),
...
function saliver_get_carousel_layout_options($post_type_name){
    $option_layouts = [];
    switch ($post_type_name) {
        ...
        case 'service':
            $option_layouts = [
                ...
                'service-2' => [
                    'label' => esc_html__( 'Layout 2', 'saliver' ),
                    'image' => get_template_directory_uri() . '/elements/assets/img/pxl_post_carousel/service-layout2.jpg'
                ],
                'service-3' => [
                    'label' => esc_html__( 'Layout 3', 'saliver' ),
                    'image' => get_template_directory_uri() . '/elements/assets/img/pxl_post_carousel/service-layout3.jpg'
                ],
            ];
            break;
        ...
        case 'portfolio':
            $option_layouts = [
                ...
                'portfolio-2' => [
                    'label' => esc_html__( 'Layout 2', 'saliver' ),
                    'image' => get_template_directory_uri() . '/elements/assets/img/pxl_post_carousel/portfolio-layout2.jpg'
                ],
            ];
            break;
...
function saliver_get_carousel_term_by_post_type($pt_supports = [], $args=[]){
    $args = wp_parse_args($args, ['condition' => 'post_type', 'custom_condition' => []]);
    $post_types  = saliver_get_post_type_options($pt_supports); 
    $result = [];
    if (!is_array($post_types))
...
*/
function saliver_get_post_click_layout($pt_supports = []){
    $post_types  = saliver_get_post_type_options($pt_supports); 
    $result = [];
    if (!is_array($post_types))
        return $result;
    foreach ($post_types as $name => $label) {
        $result[] = array(
            ...
            'type'     => 'layoutcontrol',
            'default' => 'post-1',
            'options'  => saliver_get_post_click_layout_options($name),
            'prefix_class' => 'post-layout-',
            'condition' => [
                'post_type' => [$name]
            ]
...
function saliver_get_post_click_layout_options($post_type_name){
    $option_layouts = [];
    switch ($post_type_name) {
        ...
        case 'post':  
            $option_layouts = [
                'post-1' => [
                    'label' => esc_html__( 'Layout 1', 'saliver' ),
                    'image' => get_template_directory_uri() . '/elements/assets/img/pxl_post_click/post-layout1.jpg'
                ],
            ];
            break;
...
/* Icon render */ 
function saliver_elementor_icon_render( $settings, $args = []){
...
function saliver_widget_animate() {
    $saliver_animate = array(
        '' => 'None',
        'wow bounce' => 'bounce',
        'wow flash' => 'flash',
        'wow pulse' => 'pulse',
    ...
    return $saliver_animate;
}

function saliver_widget_animate_v2() {
    $saliver_animate_v2 = array(
        '' => 'None',
        'wow bounce' => 'bounce',
        'wow bounceIn' => 'bounceIn',
        'wow bounceInDown' => 'bounceInDown',
        ...
        'wow wobble' => 'wobble',
        'wow zoomInBig' => 'zoomInBig',
        'wow zoomInSmall' => 'zoomInSmall',
        'wow zoomOut' => 'zoomOut',
    );
    return $saliver_animate_v2;
}
 ...
 * Pagram Animation
*/
if(!function_exists('saliver_widget_animation_settings')){
    function saliver_widget_animation_settings($args = []){
        $args = wp_parse_args($args, [
        ...
        return array(
            ...
            'label'     => esc_html__('Animation', 'saliver'),
            'tab'       => $args['tab'],
...
if(!function_exists('saliver_widget_color_type')){
    function saliver_widget_color_type($args = []){
        ...
        $options = array(
            array(
                ...
                'label' => $args['label'] .' '.esc_html__('Color Type', 'saliver' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => [
                    'normal' => 'Normal',
                    'gradient' => 'Gradient',
            ...
            array(
                ...
                'label' => $args['label'] .' '.esc_html__('Normal Color', 'saliver' ),
            ...
            array(
                ...
                'label' => $args['label'] .' '.esc_html__('Gradient Color', 'saliver' ),
            ...
            array(
                ...
                'label'       => ucfirst( str_replace('_', '', $args['prefix']) ).' '. esc_html__( 'Start Popover', 'saliver' ),
                'type'        => 'pxl_start_popover',
                'condition'   => $args['condition'],
            ),
            array(
                'name' => $args['prefix'].'_gradient_color_from',
                'label' => esc_html__('From', 'saliver' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
            ...
            array(
                ...
                'label'       => ucfirst( str_replace('_', '', $args['prefix']) ).' '. esc_html__( 'End Popover', 'saliver' ),
...
if(!function_exists('saliver_widget_bgcolor_type')){
    function saliver_widget_bgcolor_type($args = []){
        $gradient_prefix_class = 'pxl-';
        $gradient_return_value = 'gradient';
        $args = wp_parse_args($args, [
            'label' => '',
        ...
        $options = array(
            array(
                'name' => $args['prefix'] .'_color_type',
                'label' => esc_html__('BG Color Type', 'saliver' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => [
                    'normal' => 'Normal',
                    'gradient' => 'Gradient 1',
            ...
            array(
                'name' => $args['prefix'] .'_normal_color',
                'label' => esc_html__('Box Normal Color', 'saliver' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
            ...
            array(
                'name'        => $args['prefix'].'_gradient_color',
                'label' => $args['label'] .' '.esc_html__('BG Gradient Color', 'saliver' ),
                'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
                'prefix_class' => $gradient_prefix_class,
                'return_value' => $gradient_return_value,
                'condition' => [
...
if(!function_exists('saliver_widget_gradient_color')){
    function saliver_widget_gradient_color($args = []){
        $gradient_prefix_class = 'pxl-';
        $gradient_return_value = 'gradient';
        $args = wp_parse_args($args, [
            'label' => '',
...
if(!function_exists('saliver_widget_gradient_color_rotate')){
    function saliver_widget_gradient_color_rotate($args = []){
        $gradient_prefix_class = 'pxl-';
        $gradient_return_value = 'gradient';
        $args = wp_parse_args($args, [
            'label' => '',
        ...
        $options = array(
            ...
            array(
                ...
                'label' => esc_html__('Angle', 'saliver' ),
