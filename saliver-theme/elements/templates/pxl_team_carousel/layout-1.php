...
<?php if(isset($settings['team']) && !empty($settings['team']) && count($settings['team'])): 
    $image_size = !empty($settings['img_size']) ? $settings['img_size'] : '300x400'; ?>
    <div class="pxl-swiper-slider pxl-team pxl-team-carousel1 pxl-team-layout1" <?php if($drap !== false) : ?>data-cursor-drap="<?php echo esc_attr__('DRAG', 'saliver'); ?>"<?php endif; ?>>
        <div class="pxl-carousel-inner">
            ...
            <?php if($arrows !== false): ?>
                <div class="pxl-swiper-arrow-wrap style-1">
                    ...
                    <svg width="19" height="38" viewBox="0 0 19 38" fill="none" stroke="#687276" xmlns="http://www.w3.org/2000/svg">
                        <path d="M18.7055 0.292236L0.513611 18.6315L18.7055 36.9708"  stroke-width="0.730599" stroke-miterlimit="10"/>
                    </svg>
                    </div>
                    <div class="pxl-swiper-arrow pxl-swiper-arrow-next">
                    <svg width="20" height="38" viewBox="0 0 20 38" fill="none" stroke="#687276" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.27441 36.9708L19.4663 18.6315L1.27441 0.292236"  stroke-width="0.730599" stroke-miterlimit="10"/>
                    </svg>
                    </div>
                </div>
            <?php endif; ?>
