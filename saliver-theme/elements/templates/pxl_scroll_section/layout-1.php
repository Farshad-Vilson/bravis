<div class="pxl-scroll-sections <?php echo esc_attr($settings['style1'])?>">
            ...
            <?php
                foreach ($settings['link'] as $key => $link):
                    ...
                    <li class="pxl-item--link <?php echo esc_attr($settings['pxl_animate'])?>">
                        <a class="is-one-page <?php echo esc_html($link['style']); ?>" data-onepage-offset="300" <?php echo implode( ' ', [ $link_attributes ] ); ?>>
