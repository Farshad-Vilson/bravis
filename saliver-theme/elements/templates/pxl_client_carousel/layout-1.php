...
$reverse_autoplay = $widget->get_setting('reverse_autoplay', false);
$opts = [
    ...
    'loop'                          => (bool)$infinite,
    'speed'                         => (int)$speed,
    'reverse_autoplay'              => (bool)$reverse_autoplay,
];
...
if(isset($settings['client']) && !empty($settings['client']) && count($settings['client'])): 
    ...
    ?>
    <div class="pxl-swiper-slider pxl-client-carousel pxl-client-carousel1 <?php echo esc_attr($settings['style']); ?>" <?php if($drap !== 'false') : ?>data-cursor-drap="<?php echo esc_html('DRAG', 'saliver'); ?>"<?php endif; ?>>
