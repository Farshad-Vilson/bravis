...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-slider pxl-service-carousel pxl-service-carousel1 pxl-service-style1" <?php if($drap !== false): ?>data-cursor-drap="<?php echo esc_attr__('DRAG', 'saliver'); ?>"<?php endif; ?>>
                    ...
                    <?php
                        ...
                        <div class="pxl-swiper-slide">
                            <div class="pxl-post--inner wow <?php echo esc_attr($pxl_animate); ?>"  data-wow-duration="1.2s">
                                ...
                                <?php endif; ?>
                                <a class="button-post " href="<?php echo esc_url(get_permalink( $post->ID )); ?>"></a>
                            </div>
                        </div>    
                    <?php endforeach; ?>
                </div> 
