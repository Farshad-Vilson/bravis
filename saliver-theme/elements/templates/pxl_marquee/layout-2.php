<div class="pxl-marquee pxl-marquee__style-2 pxl-marquee__<?php echo esc_attr($settings['direction'].' pxl-marquee__'.esc_attr($settings['pause_on_hover'])); ?>" data-show="<?php echo esc_attr($settings['item_to_show']); ?>">
