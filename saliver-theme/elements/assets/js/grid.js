            ...
            $('.pxl-grid').each(function(index, element) { 
                ...
                $grid_scope.on('click', '.pxl-grid-filter .filter-item', function(e) {
                    ...
                    if( $this.closest('.pxl-grid-filter').hasClass('ajax') ){
                        ...
                        saliver_grid_ajax_handler( $this, $grid_scope, $grid_isotope, 
                            { action: 'saliver_load_more_post_grid', loadmore: loadmore, iso_options: isoOptions, handler_click: 'filter', scrolltop: 0 }
                        );
                    }else{
                ...
                $grid_scope.on('click', '.pxl-grid-pagination .ajax a.page-numbers', function(e) {
                    ...
                    saliver_grid_ajax_handler( $this, $grid_scope, $grid_isotope, 
                        { action: 'saliver_load_more_post_grid', loadmore: loadmore, iso_options: isoOptions, handler_click: 'pagination', scrolltop: 0, wpnonce: main_params.wpnonce }
                    );
                ...
                $grid_scope.on('click', '.btn-grid-loadmore', function(e) {
                    ...
                    saliver_grid_ajax_handler( $this, $grid_scope, $grid_isotope, 
                        { action: 'saliver_load_more_post_grid', loadmore: loadmore, iso_options: isoOptions, handler_click: 'loadmore', scrolltop: 0, wpnonce: main_params.wpnonce }
                    );
                });
            });
        }, 300);

        function saliver_grid_ajax_handler($this, $grid_scope, $grid_isotope, args = {}){
