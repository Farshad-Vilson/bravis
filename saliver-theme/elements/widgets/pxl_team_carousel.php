...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Bravis Team Carousel', 'saliver'),
            ...
            'sections' => array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'controls' => array(
                                ...
                                array(
                                    'name' => 'item_link',
                                    'label' => esc_html__('Link Details', 'saliver'),
                                    'type' => \Elementor\Controls_Manager::URL,
                                    'label_block' => true,
                                ),
                                array(
                                    'name' => 'social',
                                    'label' => esc_html__( 'Social', 'saliver' ),
                                    'type' => 'pxl_icons',
                                ),
                            ),
                            'title_field' => '{{{ title }}}',
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'position_color',
                            'label' => esc_html__('Position Color', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Position Typography', 'saliver' ),
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',
                ...
                array(
                    ...
                    'label' => esc_html__('Carousel Settings', 'saliver'),
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'arrows_color',
                            'label' => esc_html__('Arrows Color', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .pxl-team-layout1 .pxl-swiper-arrow-wrap.style-1 svg ' => 'stroke: {{VALUE}};'
                            ],
                            'condition' => [
                                'arrows' => 'true'
                            ]
