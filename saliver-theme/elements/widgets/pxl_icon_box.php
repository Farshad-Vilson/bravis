...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_icon_box',
        'title' => esc_html__('Bravis Icon Box', 'saliver' ),
        'icon' => 'eicon-icon-box',
            ...
            'sections' => array(
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'logo_image',
                            'label' => esc_html__( 'Logo Image', 'saliver' ),
                        ...
                        array(
                            'name' => 'pxl_icon1',
                            'label' => esc_html__('Icon 1', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::ICONS,
                            'fa4compatibility' => 'icon',
                            'condition' => [
                                'icon_type' => 'icon',
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .pxl-icon-box' => 'align-items: {{VALUE}} !important;',
                            ],
                        ),
                        array(
                            'name' => 'Justifi',
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .pxl-icon-box .pxl-tiem-title' => 'text-align: {{VALUE}} !important;',
                            ],
                        ),
                        array(
                            'name' => 'border_type',
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .pxl-icon-box' => 'border-style: {{VALUE}} !important;',
                            ],
                        ),
                        array(
                            'name' => 'border_width',
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .pxl-icon-box' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
                            ],
                            'condition' => [
                                'border_type!' => '',
                            ],
                        ...
                        array(
                            ...
                            'default' => '',
                            'selectors' => [
                                '{{WRAPPER}} .pxl-icon-box' => 'border-color: {{VALUE}} !important;',
                            ],
                            'condition' => [
                                'border_type!' => '',
                            ],
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .pxl-icon-box .pxl-item--icon svg' => 'fill: {{VALUE}};',
                            ],
                            'condition' => [
                                'pxl_icon[library]' => 'svg',
                                'icon_type' => 'icon', 
                        ...
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .pxl-icon-box .pxl-item--icon img' => 'max-width: {{SIZE}}{{UNIT}};',
                            ],
                            'condition' => [
                                'icon_type' => 'image',
                            ],
