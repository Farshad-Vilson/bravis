...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_breadcrumb',
        'title' => esc_html__('Bravis Breadcrumb', 'saliver' ),
        'icon' => 'eicon-yoast',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'text_color',
                            'label' => esc_html__('Text Color', 'saliver' ),
                        ...
                        array(
                            'name' => 'active_color',
                            'label' => esc_html__('Active Color', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'hover_color',
                            'label' => esc_html__('Hover Color', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Text Typography', 'saliver' ),
