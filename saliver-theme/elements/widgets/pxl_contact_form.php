...
if(class_exists('WPCF7')) {
    ...
    if ($cf7) {
        ...
        $contact_forms[esc_html__('No contact forms found', 'saliver')] = 0;
    }

    pxl_add_custom_widget(
        array(
            'name' => 'pxl_contact_form',
            'title' => esc_html__('Bravis Contact Form', 'saliver'),
                ...
                'sections' => array(
                    array(
                        ...
                        'controls' => array(
                            array(
                                'name' => 'form_id',
                                'label' => esc_html__('Select Form', 'saliver'),
                    ...
                    array(
                        ...
                        'label' => esc_html__('Input', 'saliver'),
                        ...
                        'controls' => array(
                            ...
                            array(
                                'name' => 'input_padding',
                                'label' => esc_html__('Padding Input', 'saliver' ),
                            ...
                            array(
                                ...
                                'default' => '',
                                'selectors' => [
                                    '{{WRAPPER}} .pxl-contact-form-1 .pxl-holder svg' => 'fill: {{VALUE}} !important;',
                                ],
                                
                            ),
                            array(
                                'name' => 'input_height',
                                'label' => esc_html__('Input Height', 'saliver' ),
                            ...
                            array(
                                ...
                                'label' => esc_html__('Textarea Height', 'saliver' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px' ],
                                'range' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Padding Textarea', 'saliver' ),
                                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                                'size_units' => [ 'px' ],
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__( 'Textarea Border Type', 'saliver' ),
                                'type' => \Elementor\Controls_Manager::SELECT,
                                'options' => [
                                    '' => esc_html__( 'None', 'saliver' ),
                                    'solid' => esc_html__( 'Solid', 'saliver' ),
                            ...
                            array(
                                ...
                                'label' => esc_html__( 'Textarea Border Width', 'saliver' ),
                                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Textarea Typography', 'saliver' ),
                                'type' => \Elementor\Group_Control_Typography::get_type(),
                                'control_type' => 'group',
                            ...
                            array(
                                'name' => 'textarea_color',
                                'label' => esc_html__('Textarea Color', 'saliver' ),
                                'type' => \Elementor\Controls_Manager::COLOR,
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Item Spacer Bottom', 'saliver' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px' ],
                                'range' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Item Spacer Left', 'saliver' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px' ],
                                'range' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Item Spacer right', 'saliver' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px' ],
                                'range' => [
                    ...
                    array(
                        ...
                        'label' => esc_html__('Input Hover', 'saliver'),
                        'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                        'controls' => array(
                            array(
                        ...
                        'controls' => array_merge(
                            array(
                                array(
                                    ...
                                    'label' => esc_html__('Button Typography', 'saliver' ),
                                    'type' => \Elementor\Group_Control_Typography::get_type(),
                                    'control_type' => 'group',
                                ...
                                array(
                                    ...
                                    'label' => esc_html__('Button Color Hover', 'saliver' ),
                                    'type' => \Elementor\Controls_Manager::COLOR,
                                    'selectors' => [
                                ...
                                array(
                                    ...
                                    'label' => esc_html__('Button Background Color', 'saliver' ),
                                    'type' => \Elementor\Controls_Manager::COLOR,
                                    'selectors' => [
                                        '{{WRAPPER}} .pxl-contact-form .wpcf7-submit, {{WRAPPER}} .pxl-contact-form button' => 'background: {{VALUE}};',
                                    ],
                                ),
                                array(
                                    'name' => 'button_bg_color_hover',
                                    'label' => esc_html__('Button Background Color Hover', 'saliver' ),
                                    'type' => \Elementor\Controls_Manager::COLOR,
                                    'selectors' => [
                            ...
                            array(
                                ...
                                array(
                                    'name' => 'btn_spacer_top',
                                    'label' => esc_html__('Spacer Top', 'saliver' ),
                                    'type' => \Elementor\Controls_Manager::SLIDER,
                                    'control_type' => 'responsive',
                                    'size_units' => [ 'px' ],
                                    'range' => [
                    ...
                    array(
                        'name' => 'extra',
                        'label' => esc_html__('Extra', 'saliver'),
                        'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                        'controls' => array(
                            array(
                                'name' => 'f_width',
                                'label' => esc_html__('Form Max Width', 'saliver' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px', '%' ],
                                'range' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Notification Color', 'saliver' ),
                                'type' => \Elementor\Controls_Manager::COLOR,
                                'selectors' => [
                            ...
                            array(
                                'name' => 'validate_color',
                                'label' => esc_html__('Validate Color', 'saliver' ),
                                'type' => \Elementor\Controls_Manager::COLOR,
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Label Spacer Bottom', 'saliver' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px' ],
                                'range' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__( 'Radio Box Shadow', 'saliver' ),
                                'type'         => \Elementor\Group_Control_Box_Shadow::get_type(),
                                'control_type' => 'group',
