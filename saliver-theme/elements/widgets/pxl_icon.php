...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_icon',
        'title' => esc_html__('Bravis Icons', 'saliver'),
        'icon' => 'eicon-alert',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'icons',
                            'label' => esc_html__('Icons', 'saliver'),
                            ...
                            'controls' => array(
                                ...
                                array(
                                    'name' => 'label_position',
                                    'label' => esc_html__('Label Position', 'saliver' ),
                        ...
                        array(
                            'name' => 'icon_arrange',
                            'label' => esc_html__( 'Arrange', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'icon-horizontal' => esc_html__( 'Horizontal', 'saliver' ),
                                'icon-vertical' => esc_html__( 'Vertical', 'saliver' ),
                            ],
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'selectors' => [
                                ...
                                '{{WRAPPER}} .pxl-icon1 a svg' => 'fill: {{VALUE}};',
                            ],
                        ),
                        array(
                            'name' => 'color_hover',
                            ...
                            'selectors' => [
                                ...
                                '{{WRAPPER}} .pxl-icon1 a:hover svg' => 'fill: {{VALUE}};',
                            ],
                        ),
                        array(
                            'name' => 'box_color',
                        ...
                        array(
                            ...
                            'label' => esc_html__( 'Box Color Hover', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'default' => '',
                            'selectors' => [
