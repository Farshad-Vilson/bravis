...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_menu',
        'title' => esc_html__('Bravis Nav Menu', 'saliver'),
        'icon' => 'eicon-nav-menu',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'menu',
                            'label' => esc_html__('Select Menu', 'saliver'),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => $pxl_menus,
                        ),
                        array(
                            'name' => 'menu_type',
                            'label' => esc_html__('Menu Type', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                        ...
                        array(
                            'name' => 'text_align',
                            'label' => esc_html__('Text Alignment', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::CHOOSE,
                            'options' => [
                                'left' => [
                                    'title' => esc_html__('Left', 'saliver' ),
                        ...
                        array(
                            'name' => 'max_height',
                            'label' => esc_html__('Max Height', 'saliver' ),
                ...
                array(
                    ...
                    'label' => esc_html__('First Level', 'saliver'),
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'color_active',
                            'label' => esc_html__('Color Active', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'arrow_color',
                            'label' => esc_html__('Arrow Color', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Arrow Has Children - Font Size', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range' => [
                                'px' => [
                        ...
                        array(
                            'name' => 'menu_mega_type',
                            'label' => esc_html__('Menu Mega Type', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Menu Mega Border Radius', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::DIMENSIONS,
                            'size_units' => [ 'px' ],
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Mega Menu Spacer Left', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range' => [
                                'px' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Mega Menu Spacer Right', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range' => [
                                'px' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Mega Menu Container Max Width', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range' => [
                                'px' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Arrow Parent', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'none' => 'None',
                                'plus' => 'Plus',
                ...
                array(
                    ...
                    'label' => esc_html__('Sub Level', 'saliver'),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'controls' => array(
                        array(
                            'name' => 'sub_color',
                        ...
                        array(
                            ...
                            'label' => esc_html__('Color Hover/Actvie', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'sub_bg_color',
                            'label' => esc_html__('Box Background Color', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Hover/Active Style', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Show Effect', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Box Spacer Top', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range' => [
                                'px' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Box Spacer Top - Mega', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range' => [
                                'px' => [
