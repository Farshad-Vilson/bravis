...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Bravis Client Carousel', 'saliver'),
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'default' => 'default',
                            'options' => [
                                'style-4' => esc_html__('Style Default', 'saliver' ),
                                'style-1' => esc_html__('Style 1', 'saliver' ),
                                'style-2' => esc_html__('Style 2', 'saliver' ),
                                'default' => esc_html__('Style 3', 'saliver' ),
                                'style-3' => esc_html__('Style 4', 'saliver' ),
                                'style-5' => esc_html__('Style 5', 'saliver' ),
                                'style-6' => esc_html__('Style 6', 'saliver' ),
                            ],
                        ),
                        array(
                            'name' => 'client',
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'reverse_autoplay',
                            'label' => esc_html__('Reverse Autoplay', 'saliver'),
                            'type' => \Elementor\Controls_Manager::SWITCHER,
                        ),
                        array(
                            'name' => 'offset_left',
