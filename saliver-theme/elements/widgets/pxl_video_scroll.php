...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_video_scroll',
        'title' => esc_html__('Bravis Video Scroll', 'saliver' ),
        'icon' => 'eicon-icon-box',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'box_image1',
                            'label' => esc_html__( 'Img Box 1', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::MEDIA,
                        ),
                        array(
                            'name' => 'box_image2',
                            'label' => esc_html__( 'Img Box 2', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::MEDIA,
                        ),
                        array(
                            'name' => 'box_image3',
                            'label' => esc_html__( 'Img Box 3', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::MEDIA,
                        ),
                        array(
                            'name' => 'btn_text',
                            'label' => esc_html__('Btn Text', 'saliver' ),
                        ...
                        array(
                            'name' => 'pxl_icon',
                            'label' => esc_html__('Btn Icon', 'saliver' ),
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .pxl-image-box .pxl-item--icon' => 'top: {{SIZE}}{{UNIT}};',
                            ],
                            'condition' => [
                                'icon_type' => 'image',
                            ],
                        ...
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .pxl-image-box .pxl-item--icon' => 'right: {{SIZE}}{{UNIT}};',
                            ],
                            'condition' => [
                                'icon_type' => 'image',
                            ],
                        ...
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .pxl-image-box .pxl-item--icon' => 'bottom: {{SIZE}}{{UNIT}};',
                            ],
                            'condition' => [
                                'icon_type' => 'image',
                            ],
                        ...
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .pxl-image-box .pxl-item--icon' => 'left: {{SIZE}}{{UNIT}};',
                            ],
                            'condition' => [
                                'icon_type' => 'image',
                            ],
