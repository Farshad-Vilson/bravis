...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_link',
        'title' => esc_html__('Bravis Links', 'saliver'),
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'wg_title',
                            'label' => esc_html__('Widget Title', 'saliver' ),
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'color_divider',
                            'label' => esc_html__('Color Divider', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'weight_divider',
                            'label' => esc_html__('Weight Divider', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'control_type' => 'responsive',
                            'size_units' => [ 'px', '%' ],
                            'range' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Typography Hover', 'saliver' ),
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',
                        ...
                        array(
                            'name' => 'bottom_spacer',
                            'label' => esc_html__('Vertical Spacer', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'control_type' => 'responsive',
                            'size_units' => [ 'px' ],
                            'range' => [
                        ...
                        array(
                            'name' => 'left_spacer',
                            'label' => esc_html__('Horizontal Spacer Left', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'control_type' => 'responsive',
                            'size_units' => [ 'px' ],
                            'range' => [
                        ...
                        array(
                            'name' => 'right_spacer',
                            'label' => esc_html__('Horizontal Spacer Right', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'control_type' => 'responsive',
                            'size_units' => [ 'px' ],
                            'range' => [
                    ...
                    'controls' => array_merge(
                        ...
                        array(
                            ...
                            array(
                                ...
                                'label' => esc_html__('Left Spacer', 'saliver' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px' ],
                                'range' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Right Spacer', 'saliver' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px' ],
                                'range' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Box Border Radius', 'saliver' ),
                            ...
                            array(
                                ...
                                'label' => esc_html__( 'Icon Shadow', 'saliver' ),
