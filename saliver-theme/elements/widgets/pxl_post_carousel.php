<?php
$pt_supports = ['post','service','portfolio','product'];
pxl_add_custom_widget(
    array(
        'name' => 'pxl_post_carousel',
        'title' => esc_html__('Bravis Post Carousel', 'saliver' ),
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array_merge(
                        ...
                        saliver_get_post_carousel_layout($pt_supports)
                    ),
                ),
                array(
                    'name' => 'section_source',
                ...
                array(
                    ...
                    'label' => esc_html__('Carousel', 'saliver'),
                    'tab' => \Elementor\Controls_Manager::TAB_SETTINGS,
                    'controls' => array(
                        array(
                            'name' => 'pxl_animate',
                            'label' => esc_html__('Saliver Animate', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                        ...
                        array(
                            'name' => 'col_md_custom',
                            'label' => esc_html__('Columns MD Custom', 'saliver' ),
                        ...
                        array(
                            'name' => 'col_lg_custom',
                            'label' => esc_html__('Columns LG Custom', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'label_block' => true,
                            'description' => 'Enter number.',
                            'condition' => [
                        ...
                        array(
                            'name' => 'col_xl_custom',
                            'label' => esc_html__('Columns XL Custom', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'label_block' => true,
                            'description' => 'Enter number.',
                            'condition' => [
                        ...
                        array(
                            'name' => 'col_xxl_custom',
                            'label' => esc_html__('Columns XXL Custom', 'saliver' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'label_block' => true,
                            'description' => 'Enter number.',
                            'condition' => [
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .pxl-swiper-slider .pxl-post--featured ' => 'border-radius: {{TOP}} {{RIGHT}} {{BOTTOM}} {{LEFT}};',
                            ],
                        ),                        
                    ),
                ),
