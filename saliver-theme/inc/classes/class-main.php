...
if (!class_exists('Saliver_Main')) { 
    class Saliver_Main extends Saliver_Base
    {
        ...
        public static function getInstance()
        {
            ...
            if (null === self::$instance) {
                self::$instance = new Saliver_Main();
            }
...
function saliver() {
    return Saliver_Main::getInstance();
}
// Install
saliver(); 
