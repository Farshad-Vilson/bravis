<main>
	<div class="pxl-dashboard-wrap">
		...
		if ( 'valid' != get_option( saliver()->get_slug().'_purchase_code_status', false ) && !$dev_mode ) :
			
			echo '<div class="error"><p>' .
					sprintf( wp_kses_post( esc_html__( 'The %s theme needs to be registered. %sRegister Now%s', 'saliver' ) ), saliver()->get_name(), '<a href="' . admin_url( 'admin.php?page=pxlart') . '">' , '</a>' ) . '</p></div>';
		elseif( !empty($plugin_requires) && sizeof($plugin_requires) >= 1 ):

			echo '<div class="error"><p>';
			echo sprintf( wp_kses_post( esc_html__( 'Make sure to activate required plugins prior to import a demo.', 'saliver' ) ), saliver()->get_name(), '<a class="nt-atpli" href="' . admin_url( 'admin.php?page=pxlart-plugins') . '">' , '</a>' ) . '</p>';
		...
		<header class="pxl-dsb-header">
			<div class="pxl-dsb-header-inner">
				<h4><?php esc_html_e( 'Import a Demo', 'saliver' ); ?></h4>
				<p><?php esc_html_e( 'Choose a pre-built website for starting a quick design process.', 'saliver' ) ?></p>
			</div>
			<div class="pxl-msg pxl-dsb-notice">
				<p><span><?php esc_html_e( 'Note:', 'saliver' ); ?></span> <?php esc_html_e( 'Make sure to activate required plugins prior to import a demo.', 'saliver' ) ?></p>
			</div>
		</header>
							...
							<figure>
								...
								<div class="pxl-btn-group">
									<a href="#" id="import-id" data-import-id="<?php echo esc_attr( $i ); ?>" data-demo-id="<?php echo esc_attr( $id ); ?>" class="pxl-btn pxl-popup-import <?php echo esc_attr( $id ); ?>">
										<span><?php esc_html_e( 'Import Demo', 'saliver' ); ?></span>
									</a><br/>
									<a target="_blank" href="<?php echo esc_url( $demo['preview'] ); ?>" class="pxl-preview-btn">
										<span><?php esc_html_e( 'Preview Demo', 'saliver' ); ?></span>
		...
		<div class="pxl-demo-content pxl-imp-popup-wrap">
			<div class="pxl-imp-popup-inner">
				...
				<div class="pxl-imp-popup-content">
					<h4 style="text-align:center; margin-bottom: 30px;"><?php esc_html_e( 'Select all or a few', 'saliver' ); ?></h4>
					<div class="pxl-row">
						<div class="pxl-col pxl-col-6">
							<span class="pxl-imp-opt">
								...
								<span><?php esc_html_e( 'Media Attachments', 'saliver' ); ?></span>
							</span>
						</div>
						<div class="pxl-col pxl-col-6">
							<span class="pxl-imp-opt">
								...
								<span><?php esc_html_e( 'Content', 'saliver' ); ?></span>
							</span>
						</div>
						<div class="pxl-col pxl-col-6">
							<span class="pxl-imp-opt">
								...
								<span><?php esc_html_e( 'Theme Options', 'saliver' ) ?></span>
							</span>
						</div>
						<div class="pxl-col pxl-col-6">
							<span class="pxl-imp-opt">
								...
								<span><?php esc_html_e( 'Widgets', 'saliver' ); ?></span>
							</span>
						</div>
						...
						<div class="pxl-col pxl-col-6">
							<span class="pxl-imp-opt">
								...
								<span><?php esc_html_e( 'Revslider', 'saliver' ); ?></span>
							</span>
						</div>
							<?php endif; ?>
						<div class="pxl-col pxl-col-6">
							<span class="pxl-imp-opt">
								...
								<span><?php esc_html_e( 'Settings', 'saliver' ) ?></span>
							</span>
						</div>
					</div>
						...
						<div class="pxl-col pxl-col-12">
							<div class="pxl-imp-skip-posts">
								<span class="pxl-imp-opt-skip-posts" style="margin-bottom: 0; padding-left: 15px;">
									...
									<span><?php esc_html_e( 'Skip the posts existen, ( Default clear all content ).', 'saliver' ); ?></span>
									</label>
								</span>
							</div>
							<div class="pxl-imp-crop">
								<span class="pxl-imp-opt-crop" style="margin-bottom: 0; padding-left: 15px;">
									...
									<label for="pxl-imp-crop-img"><span><?php esc_html_e( 'Crop Image after import finish?', 'saliver' ); ?></span></label>
								</span>
							</div>
		...
		<div class="pxl-progress-popup pxl-imp-popup-wrap">
			<div class="pxl-imp-progress">
				<h6><?php esc_html_e( 'Importing...', 'saliver' ); ?></h6>
				<div class="pxl-progress importing"><?php esc_html_e( 'Working', 'saliver' )?> <span>.</span><span>.</span><span>.</span></div>
				<div class="pxl-progressbar">
					<div class="pxl-progressbar-inner" style="width: 0%">
						<span class="pxl-loader pxl-progressbar-percentage"><?php esc_html_e( '0%', 'saliver' ); ?></span>
					</div>
				</div>
			</div>
		</div>  
