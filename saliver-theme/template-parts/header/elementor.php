<?php 
$logo_m = saliver()->get_opt( 'logo_m', ['url' => get_template_directory_uri().'/assets/img/logo.png', 'id' => '' ] );
$logo_light_m = saliver()->get_opt( 'logo_light_m', ['url' => get_template_directory_uri().'/assets/img/logo-light.png', 'id' => '' ] );
$p_menu = saliver()->get_page_opt('p_menu');
$header_mobile = saliver()->get_page_opt('header_mobile', 'show');
$sticky_scroll = saliver()->get_opt('sticky_scroll');
...
$page_mobile_style = saliver()->get_page_opt('page_mobile_style');
$opt_mobile_style = saliver()->get_opt('opt_mobile_style');
$mobile_display = saliver()->get_opt('mobile_display');
if(isset($page_mobile_style) && !empty($page_mobile_style) && $page_mobile_style != 'inherit') {
    $opt_mobile_style = $page_mobile_style;
}
$header_mobile_layout = saliver()->get_opt('header_mobile_layout');
$header_mobile_layout_count = (int)saliver()->get_opt('header_mobile_layout');
$post_header_mobile = get_post($header_mobile_layout);
$header_mobile_type = get_post_meta( $post_header_mobile, 'header_mobile_type', true );
?>
                    ...
                    <div class="row">
                        ...
                        <div class="pxl-header-menu">
                            <div class="pxl-header-menu-scroll">
                                ...
                                <?php saliver_header_mobile_search_form(); ?>
