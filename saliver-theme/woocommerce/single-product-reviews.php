	...
	<div id="comments">
		<h2 class="woocommerce-Reviews-title">
			...
			if ( $count && wc_review_ratings_enabled() ) {
				...
				echo esc_html__( 'Reviews (0)', 'woocommerce' );
			}
			?>
		</h2>
				...
				if ( wc_review_ratings_enabled() ) {
					$comment_form['comment_field'] = '
						<div class="comment-form-rating">
							<h4>' . esc_html__( 'Your Comment', 'woocommerce' ) . '</h4>
							
							<div class="rating-select-wrap">
								<label for="rating" id="comment-form-rating-label">' . esc_html__( 'Your rating for this product:', 'woocommerce' ) . ( wc_review_ratings_required() ? '&nbsp;<span class="required">*</span>' : '' ) . '</label>
						...
						<div class="comment-form-comment">
							<p class="comment-form-author">
								<label for="author">' . esc_html__( 'Your Name', 'woocommerce' ) . '</label> 
								<input id="author" name="author" type="text" value="" size="30" required />
							</p>
				
							<p class="comment-form-email">
								<label for="email">' . esc_html__( 'Business Email', 'woocommerce' ) . '</label> 
